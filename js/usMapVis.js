...
*          UsMapVis        *
* * * * * * * * * * * * * */
// this class implements the US Language Diversity Map Visualization
...
class UsMapVis {
    ...
    initVis() {
        ...
        vis.svg.append('g')
            ...
            .enter().append('text')
            .filter(d => {
                // Exclude MD, DC, DE, and RI, given that they are too small
            ...
            // Some State centroids are off-position. These adjustments are made to fix them.
            .attr('x', d => {
                const stateAbbreviation = new NameConverter().getAbbreviation(d.properties.name);
        ...
        vis.horizontalBarSvg = vis.svg.append('g')
            .attr("transform", `translate(0, ${vis.viewpoint.height - 150})`)
            .attr("class", "horizontal-bar");

        vis.xScale = d3.scaleLinear()
            .domain([0, 100])
            .range([0, vis.totalHorizontalBarWidth]);
    ...
    updateVis() {
        ...
        // calculate corresponding percentage of each language
        ...
        bars.enter().append("rect")
            ...
            .attr("y", 0)
            .attr("width", (d, i) => segmentWidths[i])
            .attr("height", 50)
            .attr("stroke", "white")
            .attr("stroke-width", 1)
        ...
        function updateLabels() {
            ...
            labels.enter()
                ...
                .attr("fill", "white")
                .text((d, i) => {
                    let code = languageCodeMap[d[0]];
                    return segmentPercentages[i] >= 4 && code ? `${code}` : '';
                })
